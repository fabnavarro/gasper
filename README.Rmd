...
```{r, echo=FALSE}
SuiteSparseData_subset <- head(SuiteSparseData, 20)
...
Here's an example of to retrieve all undirected weighted graphs with the number of columns and rows between 50 and 150:
```{r}
