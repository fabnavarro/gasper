...
```
It can be seen form Table 1 that in both cases, SURE provides a good estimator of the MSE and therefore the resulting estimators are close to the unknown risk minimizers.
