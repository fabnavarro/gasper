...
#'
#' \code{smoothmodulus} computes the modulus of smoothness for a graph signal, a measure that quantifies the irregularity or variability of a signal on a graph. In other words, it provides a measure of how much a signal varies between adjacent nodes.
#'
#' @export smoothmodulus
#' @param f vector representing the signal on the graph nodes (numeric).
