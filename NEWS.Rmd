...
# gasper 1.1.5.xxxx
* add `SuiteSparseData` data frame mirrors the structure presented on the SuiteSparse Matrix Collection website. Now enables easy querying and downloading of specific matrices directly from the Collection.
